  ...
  return (
    <>
        <ul className="max-w-[600px] m-[auto] flex flex-col items-center gap-[10px] bg-blue-950 text-gray-200 p-4">
            ...
            {percentageChecked === 100 ? <p className="text-primaryStatText"><em>Congratulation! You've completed your tasks 🤪🥰🤝</em></p> : <p>You currently have <strong className="text-secondaryStatText">( {todosLength} )</strong>  todo tasks in total. And you already completed <strong className="text-secondaryStatText">( {checkedTodo} )</strong> ({percentageChecked}%)</p>}
        </ul>
